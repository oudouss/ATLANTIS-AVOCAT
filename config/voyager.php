...
return [
    ...
    */
    ...
    'user' => [
        ...
        'default_role'                 => 'Client',
        'default_avatar'               => 'users/defaultAvatar.png',
        'redirect'                     => '/vvci',
    ],
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'translations', 'user_roles', 'lawsuit_user', 'event_user', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'settings', 'failed_jobs'],
        ],
